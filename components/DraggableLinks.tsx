            ...
            {links
                ...
                .map((link) => (
                    <div
                        ...
                        className={`p-4 border border-gray-200 rounded-lg cursor-move transition-all duration-200 ${
                    ...
                    >
                        ...
                        <div className="block sm:hidden">
                            ...
                            <div className="space-y-3">
                                ...
                                <Link
                                    ...
                                    className="inline-flex items-center justify-center w-full px-3 py-2 text-blue-600 hover:text-blue-700 hover:bg-blue-50 text-sm font-medium rounded-md border border-blue-200 hover:border-blue-300 transition-colors duration-200 touch-manipulation"
                                >
                                    <svg
                        ...
                        <div className="hidden sm:flex sm:items-center sm:justify-between">
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <Link
                                    href={`/dashboard/links/edit/${link.id}`}
                                    className="inline-flex items-center px-3 py-1.5 text-blue-600 hover:text-blue-700 hover:bg-blue-50 text-sm font-medium rounded-md transition-colors duration-200 border border-blue-200 hover:border-blue-300"
                                >
                                    <svg
